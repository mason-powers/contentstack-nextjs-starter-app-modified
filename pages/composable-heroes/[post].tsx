// THis is pulled from old commit:
// https://github.com/contentstack/contentstack-academy-playground/blob/4feedf8b3f2b74d22ab97694c042b6bb7caae808/pages/composable-heroes/%5Bpost%5D.tsx
        ...
        <div className="row">
          <div className="col-md-12 col-lg-8">
            {postData?.image?.url ? (
              <img
                className="img-fluid"
                src={postData?.image?.url + "?height=800&crop=1:1"}
          ...
          <div className="col-md-12 col-lg-4 mt-5 ps-md-5">
            <div className="row">
              ...
              <div className="col-12">
                {postData?.contact_info?.home_world?.map(
                  (
                    homeWorld: {
                    ...
                    <div key={indx.toString()} className="mb-3">
                      {homeWorld?.title ? (
                        <p>
                          <strong>Home World: </strong> {homeWorld?.title}
                        </p>
                      ) : (
                        ""
                      )}
                ...
                {postData?.powers ? (
                  <p {...(postData?.powers as {})}>
                    <strong>Power :</strong> {postData?.powers.join(", ")}
                  </p>
                ) : (
                  ""
                )}
