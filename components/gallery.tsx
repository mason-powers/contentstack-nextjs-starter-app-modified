  ...
  return (
    <>
      <div className="container">
        {heading ? (
          <h1 className="text-center mx-auto" style={{ maxWidth: "800px" }}>
            {heading}
          </h1>
        ) : (
          ""
                  ...
                  (
                    ...
                    return (
                      <React.Fragment key={index.toString()}>
                        ...
                        <div className="gallery-featured-blogs col-md-6 col-lg-3">
                                    ...
                                    <div {...elem.$?.description}>
                                      {parse(
                                        elem?.description.length > 120
                                          ? elem.description.substring(0, 120) +
                                              "..."
                                          : elem.description
                                      )}
                                    </div>
